...
const animationAliasesCubic = {
  fastIn: `0.25s ${easings.inCubic}`,
  fastOut: `0.25s ${easings.outCubic}`,
  fastInOut: `0.25s ${easings.inOutCubic}`,
  mediumIn: `0.5s ${easings.inCubic}`,
  mediumOut: `0.5s ${easings.outCubic}`,
  mediumInOut: `0.5s ${easings.inOutCubic}`,
  slowIn: `1s ${easings.inCubic}`,
  slowOut: `1s ${easings.outCubic}`,
  slowInOut: `1s ${easings.inOutCubic}`,
};

const animationAliasesQuad = {
  fastIn: `0.25s ${easings.inQuad}`,
  fastOut: `0.25s ${easings.outQuad}`,
  fastInOut: `0.25s ${easings.inOutQuad}`,
  mediumIn: `0.5s ${easings.inQuad}`,
  mediumOut: `0.5s ${easings.outQuad}`,
  mediumInOut: `0.5s ${easings.inOutQuad}`,
  slowIn: `1s ${easings.inQuad}`,
  slowOut: `1s ${easings.outQuad}`,
  slowInOut: `1s ${easings.inOutQuad}`,
};

const animationAliasesLinear = {
  fastIn: `0.25s linear`,
  fastOut: `0.25s linear`,
  fastInOut: `0.25s linear`,
  mediumIn: `0.5s linear`,
  mediumOut: `0.5s linear`,
  mediumInOut: `0.5s linear`,
  slowIn: `1s linear`,
  slowOut: `1s linear`,
  slowInOut: `1s linear`,
};
...
const commonTheme = {
  animation: {
    ...easings,
    linear: animationAliasesLinear,
    quad: animationAliasesQuad,
    cubic: animationAliasesCubic,
    quart: animationAliasesQuart,
  },
